...
### 8) Tap magnifying glass for Directory
...
### 10) Tick Audio Only, Random, and Flash
...
### 11) Go back and back to the Profile screen
...
### 18) No changes needed in this menu, go back and back to Profile screen
...
### 23) Change Is dropdown box from Off to On
...
### 23) Go back to main profile screen and tap + in top right of screen to confirm new tasks
